...
if [ -z $1 ] || [ -z $2 ] || [ -z $3 ] || [ -z $4 ]; then
    echo 'used mic binary: hash_tokenizer.mic';
...
srun --gres=mic:1 micnativeloadex ./hash_tokenizer.mic -a "/mnt/hostfs/bakadi/$1$3.xml /mnt/hostfs/bakadi/$1$2.tokens /mnt/hostfs/bakadi/$1$2.mdfa" -e "OMP_NUM_THREADS=$4 KMP_AFFINITY=granularity=fine,scatter"
