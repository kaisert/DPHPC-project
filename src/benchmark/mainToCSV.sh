...
cat $1 | tr '\n' '!' | sed 's/!![!]*/\n/g' | tr '!' ',' | sed 's/,,/\n/g' | sed 's/(total),Timing summary:/(total),#matches: 00042000,Timing summary:/g' | sed 's/[^:]*: \([^,]*\)[^:]*: \([^,]*\),[^=]*=\([^,]*\),[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)/\1,\2,\3,\4,\5,\6:::/' | sed 's/:::\([0-9]*\)[^:]*:[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)[^:]*: \([0-9]*\)[^:]*: \([0-9]*\).*/\1,\2,\3,\4,\5,\6,\7/' | sed 's/00042000/-1/g' >> "$1.csv"
