...
parallelization. We refer the reader to \todo{pptranducer} for a more elaborate
discussion.

\mypar{XML parsing and querying.} As XML is a context-free language, XML
documents can be parsed and represented as parse trees. There exist approaches
to parallelize parse tree querying \todo{35 in pptranducer}. However, parsing an
