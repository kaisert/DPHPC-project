...
on a single commercial/home computer, there exists a demand for a high performance 
computating system in combination with a well parallelizable approach to parse and query
the XML data in real time. Thus we investigate and present a new approach to query XML 
data using the XPath query language.
\end{abstract}
